...
func NewEngine(docs []Doc, cfg EngineConfig) *Engine {
	e := &Engine{
		Docs:       docs,
...
func (e *Engine) Search(query string, k int) []SearchResult {
	...
	for i, d := range e.Docs {
		...
		if e.Cfg.WBm25 > 0 {
			score += e.Cfg.WBm25 * e.bm25(i, qTokSet)
		}
...
func (e *Engine) bm25(docIdx int, qTokSet map[string]bool) float64 {
...
var reToken = regexp.MustCompile(`[A-Za-z0-9]+`)
